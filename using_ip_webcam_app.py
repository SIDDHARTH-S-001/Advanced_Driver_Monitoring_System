...
url = "http://192.168.63.24:8080/video" # Laptop and Mobile must be connected to same network.
...
while True:
    ...
    frane = cv2.cvtColor(frame, cv2.COLOR_BGR2RGB)
    ...
    if results.multi_face_landmarks:
        ...
        draw_landmarks(frane, results, left_eye_top_bottom, red)
